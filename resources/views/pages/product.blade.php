            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <table class="w-full mt-5 divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td class="px-10 py-6  text-sm text-gray-500">{{$product->name}}</td>
                            <td class="px-10 py-6  text-sm text-gray-500">{{$product->slug}}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="2" class="px-10 py-6  text-sm font-medium text-gray-900">No products</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
